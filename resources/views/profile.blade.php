    ...
    <div class="card-body">
        ...
        {{method_field('PUT')}}
            <div class="form-group">
                ...
                placeholder="Your Name" name="name" required autocomplete="name" autofocus value="{{ Auth::user()->name }}">
            ...
            <div class="form-group">
                ...
                placeholder="Email Address" name="email" required autocomplete="email" value="{{ Auth::user()->email }}">
            ...
            <div class="form-group">
                ...
                id="password" placeholder="Password (Leave blank if not change)" name="password" autocomplete="new-password">
